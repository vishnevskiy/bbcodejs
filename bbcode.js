...
// Generated by CoffeeScript 1.7.1
(function() {
  var bbcode, key, _COSMETIC_DICT, _COSMETIC_RE, _ESCAPE_DICT, _ESCAPE_RE, _URL_RE,
    __slice = [].slice;
...
// Generated by CoffeeScript 1.7.1
(function() {
  var CenterTag, CodeTag, ColorTag, HorizontalRuleTag, ImageTag, LinkTag, ListItemTag, ListTag, QuoteTag, RightTag, SizeTag, bbcode, _LINE_BREAK, _NEWLINE_RE,
...
// Generated by CoffeeScript 1.7.1
(function() {
  var bbcode, _SPACE_RE, _START_NEWLINE_RE, _TOKEN_RE,
    __indexOf = [].indexOf || function(item) { for (var i = 0, l = this.length; i < l; i++) { if (i in this && this[i] === item) return i; } return -1; };
