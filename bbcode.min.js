...
(c=function(){var a,c;a=this.params;c=[];for(b in a)e=a[b],c.push([b,e].join("="));return c}.call(this).join(" "),this.name in this.params?j.push("["+c+"]"):j.push("["+this.name+" "+c+"]")):j.push("["+this.name+"]"));j.push(this.getContent(!a));this.name!==null&&(d=this.name,h.call(this.CLOSED_BY,d)<0)&&j.push("[/"+this.name+"]");return j.join("")};a.prototype._toHTML=function(){return[this.toText(!0)]};a.prototype.toHTML=function(){return this._toHTML().join("")};return a}();g=function(){function a(){a.__super__.constructor.apply(this,
arguments);this.STRIP_INNER=!0;this._inline=this.params.code==="inline";if(!this._inline)this.STRIP_OUTER=!0}i(a,this.bbcode.Tag);a.prototype._toHTML=function(){var a;return this._inline?["<code>",this.getContent(!0),"</code>"]:(a=this.params.lang||this.params[this.name])?['<pre class="prettyprint lang-'+a+'">',this.getContent(!0),"</pre>"]:["<pre>",this.getContent(!0),"</pre>"]};return a}.call(this);d=function(){function a(){a.__super__.constructor.apply(this,arguments)}i(a,this.bbcode.Tag);a.prototype._toHTML=
function(){var a;a={src:this.renderer.strip(this.getContent(!0))};"width"in this.params&&(a.width=this.params.width);"height"in this.params&&(a.height=this.params.height);return["<img "+this.renderer.htmlAttributes(a)+" />"]};return a}.call(this);f=function(){function a(){a.__super__.constructor.apply(this,arguments)}i(a,this.bbcode.Tag);a.prototype._toHTML=function(){var a;a=this.params.size;return isNaN(a)?this.getContent():['<span style="font-size:'+a+'px">',this.getContent(),"</span>"]};return a}.call(this);
l=function(){function a(){a.__super__.constructor.apply(this,arguments)}i(a,this.bbcode.Tag);a.prototype._toHTML=function(){var a;a=this.params.color;return!a?this.getContent():['<span style="color:'+a+'">',this.getContent(),"</span>"]};return a}.call(this);n=function(){function a(){a.__super__.constructor.apply(this,arguments)}i(a,this.bbcode.Tag);a.prototype._toHTML=function(){return['<div style="text-align:center;">',this.getContent(),"</div>"]};return a}.call(this);o=function(){function a(){a.__super__.constructor.apply(this,
arguments)}i(a,this.bbcode.Tag);a.prototype._toHTML=function(){return['<div style="float:right;">',this.getContent(),"</div>"]};return a}.call(this);m=function(){function a(){a.__super__.constructor.apply(this,arguments);this.STRIP_OUTER=this.SELF_CLOSE=!0}i(a,this.bbcode.Tag);a.prototype._toHTML=function(){return["<hr />"]};return a}.call(this);b=function(){function a(){a.__super__.constructor.apply(this,arguments);this.STRIP_OUTER=this.STRIP_INNER=!0}i(a,this.bbcode.Tag);a.prototype._toHTML=function(){var a;
a=this.params.list;return a==="1"?["<ol>",this.getContent(),"</ol>"]:a==="a"?['<ol style="list-style-type:lower-alpha;">',this.getContent(),"</ol>"]:a==="A"?['<ol style="list-style-type:upper-alpha;">',this.getContent(),"</ol>"]:["<ul>",this.getContent(),"</ul>"]};return a}.call(this);c=function(){function a(){a.__super__.constructor.apply(this,arguments);this.CLOSED_BY=["*","/list"];this.STRIP_INNER=!0}i(a,this.bbcode.Tag);a.prototype._toHTML=function(){return["<li>",this.getContent(),"</li>"]};
return a}.call(this);p=function(){function a(){a.__super__.constructor.apply(this,arguments);this.STRIP_OUTER=this.STRIP_INNER=!0}i(a,this.bbcode.Tag);a.prototype._toHTML=function(){var a,b;b=["<blockquote>",this.getContent()];if(a=this.params.quote)b.push("<small>"),b.push(a),b.push("</small>");b.push("</blockquote>");return b};return a}.call(this);a=function(){function a(){a.__super__.constructor.apply(this,arguments)}i(a,this.bbcode.Tag);a.prototype._toHTML=function(){var a;a=this.renderer.strip(this.params[this.name]||
this.getContent(!0));/javascript:/i.test(a)?a="":/:/.test(a)||(a="http://"+a);return a?this.renderer.context({linkify:!1},q(function(){return['<a href="'+a+'" target="_blank">',this.getContent(),"</a>"]},this)):[this.getContent()]};return a}.call(this);this.bbcode.createSimpleTag=q(function(a,b){return function(){function c(){var a,e;c.__super__.constructor.apply(this,arguments);for(a in b)e=b[a],this[a]=e}i(c,this.bbcode.Tag);c.prototype._toHTML=function(){var b;(b=this.renderer.htmlAttributes(this.params))&&
(b=" "+b);return["<"+a+b+">",this.getContent(),"</"+a+">"]};return c}.call(this)},this);this.bbcode.BUILTIN={b:this.bbcode.createSimpleTag("strong"),i:this.bbcode.createSimpleTag("em"),u:this.bbcode.createSimpleTag("u"),s:this.bbcode.createSimpleTag("strike"),h1:this.bbcode.createSimpleTag("h1",{STRIP_OUTER:!0}),h2:this.bbcode.createSimpleTag("h2",{STRIP_OUTER:!0}),h3:this.bbcode.createSimpleTag("h3",{STRIP_OUTER:!0}),h4:this.bbcode.createSimpleTag("h4",{STRIP_OUTER:!0}),h5:this.bbcode.createSimpleTag("h5",
{STRIP_OUTER:!0}),h6:this.bbcode.createSimpleTag("h6",{STRIP_OUTER:!0}),pre:this.bbcode.createSimpleTag("pre"),table:this.bbcode.createSimpleTag("table",{DISCARD_TEXT:!0}),thead:this.bbcode.createSimpleTag("thead",{DISCARD_TEXT:!0}),tbody:this.bbcode.createSimpleTag("tbody",{DISCARD_TEXT:!0}),tr:this.bbcode.createSimpleTag("tr",{DISCARD_TEXT:!0}),th:this.bbcode.createSimpleTag("th"),td:this.bbcode.createSimpleTag("td"),code:g,img:d,hr:m,size:f,center:n,right:o,color:l,list:b,"*":c,quote:p,url:a,link:a}}).call(this);
